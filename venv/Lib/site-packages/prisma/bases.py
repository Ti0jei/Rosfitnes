...
class BaseFatSecretToken(_PrismaModel):
    __prisma_model__: ClassVar[Literal['FatSecretToken']] = 'FatSecretToken'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.FatSecretTokenActions[_PrismaModelT]':
        from .client import get_client

        return actions.FatSecretTokenActions[_PrismaModelT](client or get_client(), cls)
